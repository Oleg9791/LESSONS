...
$sql = "SELECT * FROM `{$config['mysql']['table']}` WHERE id = $_GET[id]";// запрос из всей таблицы, где id равно исходной строке
...
<form action="edit.php" method="POST">
    ...
    foreach ($fields as $field) {  //формирует поля для формы
        ?>
